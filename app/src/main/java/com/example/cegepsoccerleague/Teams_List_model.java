...
public class Teams_List_model {
    String team_id, team_name, team_icon, team_manager_id,team_manager_name, team_manager_contact,league_id;

    public Teams_List_model(String team_id, String team_name, String team_icon, String team_manager_id, String team_manager_name, String team_manager_contact, String league_id) {
